...
const AUTH_PERMISSIONS = Object.freeze({
  ...
  MUTATE_APPOINTMENT_REMINDERS: "mutate_appointment_reminders",
  MUTATE_EMPTY_SLOTS: "mutate_empty_slots",
...
const PERMISSIONS_BY_ROLE = Object.freeze({
  ...
  [AUTH_ROLES.SECRETARY]: Object.freeze([
    ...
    AUTH_PERMISSIONS.MUTATE_APPOINTMENT_REMINDERS,
    AUTH_PERMISSIONS.MUTATE_EMPTY_SLOTS,
