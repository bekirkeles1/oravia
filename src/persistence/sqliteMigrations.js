const MIGRATIONS = Object.freeze([
  ...
  Object.freeze({
    version: 6,
    name: "empty_slot_filling_engine",
    statements: Object.freeze([
      `CREATE TABLE IF NOT EXISTS empty_slot_opportunities (
        clinic_id TEXT NOT NULL,
        ...
        safe_closure_category TEXT,
        created_at TEXT NOT NULL,
        updated_at TEXT NOT NULL,
        PRIMARY KEY (clinic_id, opportunity_id),
        UNIQUE (clinic_id, source_fingerprint),
        FOREIGN KEY (clinic_id) REFERENCES clinics(clinic_id)
      )`,
      `CREATE INDEX IF NOT EXISTS idx_empty_slot_opportunities_status
        ON empty_slot_opportunities (clinic_id, status, slot_start_at)`,
      `CREATE TABLE IF NOT EXISTS empty_slot_consents (
        clinic_id TEXT NOT NULL,
        appointment_id TEXT NOT NULL,
        enabled INTEGER NOT NULL,
        same_doctor_only INTEGER NOT NULL,
      ...
      `CREATE TABLE IF NOT EXISTS empty_slot_offers (
        clinic_id TEXT NOT NULL,
        offer_id TEXT NOT NULL,
        opportunity_id TEXT NOT NULL,
        opportunity_version INTEGER NOT NULL,
        candidate_appointment_id TEXT NOT NULL,
        candidate_appointment_version INTEGER NOT NULL,
        wave_number INTEGER NOT NULL,
        ranking_position INTEGER NOT NULL,
        status TEXT NOT NULL,
        expires_at TEXT NOT NULL,
        outbound_operation_reference TEXT NOT NULL,
        provider_message_reference TEXT,
        response_type TEXT,
        safe_failure_category TEXT,
        created_at TEXT NOT NULL,
        updated_at TEXT NOT NULL,
        PRIMARY KEY (clinic_id, offer_id),
        UNIQUE (clinic_id, opportunity_id, candidate_appointment_id),
        FOREIGN KEY (clinic_id, opportunity_id) REFERENCES empty_slot_opportunities(clinic_id, opportunity_id),
        FOREIGN KEY (clinic_id, candidate_appointment_id) REFERENCES appointments(clinic_id, appointment_id)
      )`,
      `CREATE INDEX IF NOT EXISTS idx_empty_slot_offers_opportunity
        ON empty_slot_offers (clinic_id, opportunity_id, status)`,
      `CREATE INDEX IF NOT EXISTS idx_empty_slot_offers_candidate
        ON empty_slot_offers (clinic_id, candidate_appointment_id, created_at)`,
    ]),
  }),
]);
